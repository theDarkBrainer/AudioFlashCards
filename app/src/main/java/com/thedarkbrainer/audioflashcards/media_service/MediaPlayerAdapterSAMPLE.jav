...
public final class MediaPlayerAdapter extends PlayerAdapter {
    ...
    public void playFromMedia(MediaMetadataCompat metadata) {
        ...
        playFile("the_coldest_shoulder.mp3");
    }

    @Override
    public MediaMetadataCompat getCurrentMedia() {
        Log.d("MediaPlayerAdapter", "MediaPlayerAdapter::getCurrentMedia");
    ...
    private long getAvailableActions() {
        Log.d("MediaPlayerAdapter", "MediaPlayerAdapter::getAvailableActions");
    ...
    public void seekTo(long position) {
        Log.d("MediaPlayerAdapter", "MediaPlayerAdapter::seekTo");
        if (mMediaPlayer != null) {
    ...
    public void setVolume(float volume) {
        Log.d("MediaPlayerAdapter", "MediaPlayerAdapter::setVolume");
        if (mMediaPlayer != null) {
